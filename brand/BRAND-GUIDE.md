...
| Dim | `#948A8C` | Muted / secondary text |

## Typefaces (all free)

- **Archivo** — display / headings / wordmark
- **Instrument Serif** *(italic)* — editorial accents (e.g. "*more.*")
- **Inter** — body text

## Files also in this project

- `privacy-policy.md` — the privacy policy as plain text/markdown (for your records or to paste elsewhere)
- The live styled privacy page ships with the site at `/privacy.html`
